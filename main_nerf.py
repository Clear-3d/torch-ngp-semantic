...
if __name__ == '__main__':
    ...
    parser.add_argument('path', type=str,default="/data/dmsr/bathroom/train")
    ...
    parser.add_argument('--workspace', type=str, default='/data/dmsr/bathroom/train_rebuild/test')
    ...
    if opt.ff:
        ...
        from nerf.network_sem import NeRFNetwork


    print(opt) # check your initial messages
    ...
    if opt.test:
        ...
        metrics = [PSNRMeter(), LPIPSMeter(device=device)]
        trainer = Trainer('ngp', opt, model, device=device, workspace=opt.workspace, optimizer=optimizer, criterion=[criterion,criterion2], ema_decay=0.95, fp16=opt.fp16, lr_scheduler=scheduler, scheduler_update_every_step=True, metrics=metrics, use_checkpoint=opt.ckpt, eval_interval=2) # eval_interval means evaluate every few intervals
