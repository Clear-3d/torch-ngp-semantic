...
class NeRFGUI:
    ...
    def test_step(self):
        ...
        if self.need_update or self.spp < self.opt.max_spp:
            ...
            if self.dynamic_resolution:
                ...
                downscale = min(1, max(1/4, math.sqrt(400 / full_t)))
    ...
    def register_dpg(self):
        ...
        dpg.create_viewport(title='torch-ngp-semantic', width=self.W, height=self.H, resizable=False)
